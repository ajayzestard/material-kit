            ...
            var t = 'ripples',
                ...
                d = function() {
                    ...
                    return o.dispose = function() {
                        ...
                        var e = this.$element.data('ripple-color') ? this.$element.data('ripple-color') : "rgb(255, 255, 255)";
                        return e
                    }, o._isTouch = function() {
                        ...
                        return 2 * (i(this.$element.outerWidth(), this.$element.outerHeight()) / this.$decorator.outerWidth())
                    }, t._jQueryInterface = function(o) {
                        return this.each(function() {
                            var a = e(this),
                                r = a.data(n);
